...
* @returns {string}
*/
export function run_simulation(thermostat_temperature, latitude, longitude, num_occupants, house_size, postcode, epc_space_heating, tes_volume_max, agile_tariff_per_hour_over_year, hourly_outside_temperatures_over_year, hourly_solar_irradiances_over_year, enable_optimisation) {
    try {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sim_lib_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
